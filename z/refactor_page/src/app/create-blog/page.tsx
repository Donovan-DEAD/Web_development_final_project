...
export default function CreateBlogPage() {
  ...
  // Placeholder for user data (to be passed to Navbar)
  const username = "User Name"; // Replace with actual user name
  const user = { permsLabel: 'admin' }; // Replace with actual user permissions
  ...
  const handleSubmit = async (event: React.FormEvent) => {
    ...
    let collectedReferencesData: ReferenceData[] = [];
  ...
  return (
    <>
      <Navbar username={username} currentPage="create_blog" user={user} />
